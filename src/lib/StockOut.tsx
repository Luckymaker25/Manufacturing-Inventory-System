...
import {
  CheckCircle2, AlertTriangle, Clock, Factory,
  Loader2, ClipboardList, XCircle, ShoppingCart, PackageCheck,
} from 'lucide-react';
import { cn } from '@/lib/utils';

// ---------------------------------------------------------------------------
// Material Request Modal (for Production work orders)
// ---------------------------------------------------------------------------
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-slate-500">
                Batch: <span className="text-indigo-600 font-bold">{order.batch_id}</span> •{' '}
                {order.product_name}
              </p>
            </div>
          </div>
                  ...
                  >
                    <div>
                      ...
                      <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                        Current Stock:{' '}
                        <span className={isInsufficient ? 'text-rose-600' : 'text-emerald-600'}>
...
// ---------------------------------------------------------------------------
// Production Material Requests tab
// ---------------------------------------------------------------------------
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500 font-medium">
                      Target: {order.target_qty} {order.unit}
                    </p>
                  </div>
                </div>
                <button
...
// ---------------------------------------------------------------------------
// Sales Fulfillment Requests tab
...
const SalesFulfillmentRequests = () => {
  ...
  const handleApprove = async (item: PendingSalesProduction) => {
    ...
    try {
      // approveFulfillment menggunakan order_id (bukan item_id)
      ...
      <div className="grid grid-cols-1 gap-4">
        {loading ? (
          ...
          requests.map((item) => {
            ...
            const itemId = item.item_id;
            const isInsufficient = item.current_stock < item.target_qty;
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-500 font-medium mt-1 space-y-1">
                        <p>
                          Customer:{' '}
                          <span className="text-slate-900">{item.customer_name || 'Walk-in'}</span>
                        </p>
                  ...
                  <button
                    ...
                    disabled={processingId === itemId || isInsufficient}
                    className={cn(
